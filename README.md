...
forge-model-serve-probe is a Haskell project for ml utilities. It focuses on this technical goal: Create a Haskell reference implementation for serve workflows, centered on incremental indexing, append-only fixtures, and checkpoint recovery checks.
...
The core module exposes a small scoring API. Inputs are simple numeric signals: demand, capacity, latency, risk, and weight. The score uses a threshold of 184, risk penalty 6, latency penalty 4, and weight bonus 4. Tests exercise the public API against the fixture cases in `fixtures/cases.csv`.
